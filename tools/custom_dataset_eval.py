...
class customDataset(Dataset):
    ...
    def __init__(self, dataset_dir, transforms=None, window=0):
        ...
        # self.label_array['steer_t'] -= self.STEER_NEUTRAL
        # self.label_array['steer_t'] /= 400
        # self.label_array['throttle_t'] -= self.THROTTLE_NEUTRAL
        # self.label_array['throttle_t'] /= 400
